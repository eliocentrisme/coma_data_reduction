...
gaincal(vis=msfile, caltable=f'selfcal/gains_cycle_5.cal', solint='80s', refant='ea09', gaintype='G', calmode='p')

applycal(vis=msfile, gaintable=f'selfcal/gains_cycle_5.cal', calwt=False)
