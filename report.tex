...
.5 selfcal.
.5 selfcal\_images.
.5 coma\_lbandD0330.ms \DTcomment{This is the calibrated data for the target only.}.
.5 coma\_lbandD0330shifted.ms \DTcomment{This is the calibrated data for the target only, shifted to J2000 12:54:11.712400 +27.37.30.465000}.
.5 coma\_lbandD0330\_unshifted.ms \DTcomment{This is the calibrated data for the target only, shifted back to original coordinates. Other MS follow the same idea with 2,3,... indicating that I shifted back and forth between J2000 12:54:11.712400 +27.37.30.465000 and original coordinates}.
.5 \href{https://github.com/eliocentrisme/coma_data_reduction/blob/main/coma-lband/darray/03.30/lbandD0330_selfcal.py}{lbandD0330\_selfcal.py} \DTcomment{Script used for the self-calibration of this data.}.
.5 \href{https://github.com/eliocentrisme/coma_data_reduction/blob/main/coma-lband/darray/03.30/lbandD0330shifted_selfcal.py}{lbandD0330shifted\_selfcal.py} \DTcomment{Script used for the self-calibration of this data shifted to J2000 12:54:11.712400 +27.37.30.465000}.
.4 04.15.
.5 selfcal.
.5 selfcal\_images.
.5 \DTcomment{MS following same idea as for 03.30.}.
.5 \href{https://github.com/eliocentrisme/coma_data_reduction/blob/main/coma-lband/darray/04.15/lbandD0415_selfcal.py}{lbandD0415\_selfcal.py} \DTcomment{Script used for the self-calibration of this data.}.
.5 \href{https://github.com/eliocentrisme/coma_data_reduction/blob/main/coma-lband/darray/04.15/lbandD0415shifted_selfcal.py}{lbandD0415shifted\_selfcal.py} \DTcomment{Script used for the self-calibration of this data shifted to J2000 12:54:11.712400 +27.37.30.465000}.
...
\subsection{L-band D-configuration: 2021-03-30 and 2021-04-15}
\begin{itemize}
    \item Directory: \verb|./coma-lband/darray/03.30| or \verb|./coma-lband/darray/04.15|
    \item Calibration: VLA calibration pipeline.
    \item Self-calibration: 5 cycles of phase calibration (inf, 300s, 200s, 100s); check if calibration tables look good.
    \item Phase shift to J2000 12:54:11.712400 +27.37.30.465000 using phaseshift() and do a few cycles of self-calibration and check if bright source is properly deconvolved.
    \item Phase shift back to original coordinates and finish self-calibration.
    \item 
    \item \textbf{Remaining work}: do self-calibration.
\end{itemize}

% \subsection{L-band D-configuration: 2021-04-15}
% \begin{itemize}
%     \item Directory: \verb|./coma-lband/darray/04.15|
%     \item Calibration: VLA calibration pipeline.
%     \item \textbf{Remaining work}: do self-calibration.
% \end{itemize}
